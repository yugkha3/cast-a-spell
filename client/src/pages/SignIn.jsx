				...
				<div className="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0" >
					...
					<div className="w-full py-6 z-20">
						...
						<p className="text-2xl">
							Train your face on the Stable Diffusion 1.5 Model to generate AI avatars. Currently not supported for Safari. (Check this <a href="https://github.com/yugkha3/cast-a-spell/issues/1">issue</a> for more information.)
						</p>
